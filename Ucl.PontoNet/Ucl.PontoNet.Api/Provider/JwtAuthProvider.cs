...
namespace Ucl.PontoNet.Api.Provider
{
    public static class JwtAuthProvider
    {
        public static void ConfigureJwtServices(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            .AddScheme<BasicAuthenticationOptions, CustomAuthenticationHandler>("Basic", o =>
            {
                o.UserinfoEndpoint = OauthOptions["UserinfoEndpoint"];
            })
